...
router.put('/edit', authenticateHR, checkBlacklistedToken, hrController.editProfileHR);
...
router.post('/upload-salary-slip/:employeeId', authenticateHR, upload.single('salarySlip'), hrController.uploadSalarySlip);
